...
To contribute to zsh-restic project on [GitHub](https://github.com/hadenlabs/zsh-restic), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-restic/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to zsh-restic project on Gitlab:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-restic.git
```

Now your **upstream** points to **hadenlabs/zsh-restic**.
...
git fetch upstream # assuming upstream is rfid/zsh-restic
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-restic/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
